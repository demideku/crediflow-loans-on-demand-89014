...
import { TrendingUp, ArrowLeft, FileText, ClipboardList, BarChart3, Bell, CreditCard, Banknote, Receipt } from "lucide-react";
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Verify user payments</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Monitor loan repayments</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
